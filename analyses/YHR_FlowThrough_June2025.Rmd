...
Wk1_0730_MIMS_V1 <- read.csv("../data/OriginalCalc_badAr/Wk1_730MIMS_TimeCurves.csv")
Wk2_0731_MIMS_V1 <- read.csv("../data/OriginalCalc_badAr/Wk2_731MIMS_TimeCurves.csv")

# Fluxes with constant and incorrect Ar calculation:
Wk1_0730_MIMS_V2 <- read.csv("../data/Ar_ReCalc_Dec2025_badAr2/Wk1_730MIMS_TimeCurves.csv")
Wk2_0731_MIMS_V2 <- read.csv("../data/Ar_ReCalc_Dec2025_badAr2/Wk2_731MIMS_TimeCurves.csv")
...
```{r}
# date times:
Wk1_0730_MIMS_V1$Time <- as.POSIXct(Wk1_0730_MIMS_V1$Time, format = "%m/%d/%y %H:%M")
Wk2_0731_MIMS_V1$Time <- as.POSIXct(Wk2_0731_MIMS_V1$Time, format = "%m/%d/%y %H:%M")
...
Wk1_0730_MIMS_V3$Time <- as.POSIXct(Wk1_0730_MIMS_V2$Time, format = "%m/%d/%y %H:%M")
Wk2_0731_MIMS_V3$Time <- as.POSIXct(Wk2_0731_MIMS_V2$Time, format = "%m/%d/%y %H:%M")
```

```{r split core IDs off of orig.ID}
Wk1_0730_MIMS_V1$CoreID <- substr(Wk1_0730_MIMS_V1$Orig.ID, 1, 3)
Wk2_0731_MIMS_V1$CoreID <- substr(Wk2_0731_MIMS_V1$Orig.ID, 1, 3)
...
```{r µM Ar Week 1 V1}
plot.uM.Ar_Wk1_V1 <- ggplot(data = Wk1_0730_MIMS_V1, aes(x = Time, y = uM.Ar)) +
  facet_grid(~CoreID)+
...
```{r µM Ar Week 2 V1}
plot.uM.Ar_Wk2_V1 <- ggplot(data = Wk2_0731_MIMS_V1, aes(x = Time, y = uM.Ar)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r Ar flux Week 1 V1}
plot.Ar_flux_Wk1_V1 <- ggplot(data = Wk1_0730_MIMS_V1, aes(x = Time, y = Ar.flux..umol.Ar.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r Ar flux Week 2 V1}
plot.Ar_flux_Wk2_V1 <- ggplot(data = Wk2_0731_MIMS_V1, aes(x = Time, y = Ar.flux..umol.Ar.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r N2 flux Week 1 V1}
plot.N2_flux_Wk1_V1 <- ggplot(data = Wk1_0730_MIMS_V1, aes(x = Time, y = N2.flux..umol.N.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r N2 flux Week 2 V1}
plot.N2_flux_Wk2_V1 <- ggplot(data = Wk2_0731_MIMS_V1, aes(x = Time, y = N2.flux..umol.N.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r O2 flux Week 1 V1}
plot.O2_flux_Wk1_V1 <- ggplot(data = Wk1_0730_MIMS_V1, aes(x = Time, y = O2.flux..umol.O2.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
```{r O2 flux Week 2 V1}
plot.O2_flux_Wk2_V1 <- ggplot(data = Wk2_0731_MIMS_V1, aes(x = Time, y = O2.flux..umol.O2.m.2.hr.1.)) +
  facet_grid(~CoreID)+
  geom_line(linewidth = 1) +
  geom_point(size = 4)+
  theme_bw() +
...
# Week 1
Wk1_fluxes_comb_V1 <- ggarrange(plotlist = c(plot.uM.Ar_Wk1_V1, plot.Ar_flux_Wk1_V1, plot.N2_flux_Wk1_V1, plot.O2_flux_Wk1_V1), ncol = 1, nrow = 4, align = "v")

Wk1_fluxes_comb_V1

#ggsave("../figures/V1_bad_Ar_calc/Week1_fluxes.png", plot=Wk1_fluxes_comb_V1, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")

# Week 2
Wk2_fluxes_comb_V1 <- ggarrange(plotlist = c(plot.uM.Ar_Wk2_V1, plot.Ar_flux_Wk2_V1, plot.N2_flux_Wk2_V1, plot.O2_flux_Wk2_V1), ncol = 1, nrow = 4, align = "v")

Wk2_fluxes_comb_V1

#ggsave("../figures/V1_bad_Ar_calc/Week2_fluxes.png", plot=Wk2_fluxes_comb_V1, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")
```
...
#ggsave("../figures/V2_bad_Ar_calc/Week1_fluxes_V2.png", plot=Wk1_fluxes_comb_V2, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")
...
#ggsave("../figures/V2_bad_Ar_calc/Week2_fluxes_V2.png", plot=Wk2_fluxes_comb_V2, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")
```
