...
plot.N2_Wk1_Wk2 <- ggplot(Core_Averages, aes(x=Plot, y=Mean_N2_Flux)) +
  ...
  theme(text=element_text(size=10),axis.title=element_text(size=10,face="bold"),
          ...
          axis.text.x = element_text(angle = 0),panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 10), legend.position="none", legend.title = element_text(size=10), legend.text=element_text(size=10)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
