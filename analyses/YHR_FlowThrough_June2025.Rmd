...
plot.uM.Ar_Wk1 <- ggplot(data = Wk1_0730_MIMS, aes(x = Time, y = uM.Ar)) +
  ...
  scale_x_datetime(breaks = "6 hours", limits = as.POSIXct(c("2025-06-11 15:00:00", "2025-06-12 15:00:00"), tz = "America/New_York"), date_labels = "%m/%d %H:%M")
...
plot.uM.Ar_Wk2 <- ggplot(data = Wk2_0731_MIMS, aes(x = Time, y = uM.Ar)) +
  ...
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA), axis.text.x = element_blank())+
  scale_x_datetime(breaks = "6 hours", limits = as.POSIXct(c("2025-06-18 13:00:00", "2025-06-19 13:00:00"), tz = "America/New_York"), date_labels = "%m/%d %H:%M")
...
#ggsave("../figures/Week1_fluxes.png", plot=Wk1_fluxes_comb, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")
...
#ggsave("../figures/Week2_fluxes.png", plot=Wk2_fluxes_comb, device="png", scale=1, width=21, height=16, dpi=600, limitsize=TRUE, bg="white")
```
